...
random.seed(10)
randomDays = [] #empty list
for _ in range(5):
    randomDays.append(summer_2019[random.randrange(len(summer_2019))])
    #append a random summer day from 2019 to the random days list

# TODO: what was the windiest of those 5 days?
print(max(randomDays, key=lambda d:d['awnd']))